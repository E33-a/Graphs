...
func _ready() -> void:
	...
	var button1 = $VBoxContainer/btn_select_level
...
func _on_btn_volume_pressed() -> void:
	...
	get_tree().change_scene_to_file("res://Scenes/Other_scenes/configurations.tscn")
...
func _on_btn_select_level_pressed() -> void:
	select_audio.play()
	await get_tree().create_timer(0.5).timeout
	get_tree().change_scene_to_file("res://Scenes/Other_scenes/select_level.tscn")
